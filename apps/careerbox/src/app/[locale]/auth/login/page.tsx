...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to dashboard (will be determined by user type)
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <Link href={`/${locale}/auth/signup`} className="text-blue-600 hover:text-blue-500">
            Sign up for free
          </Link>
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href={`/${locale}/auth/forgot-password`} className="text-blue-600 hover:text-blue-500">
                  Forgot password?
                </Link>
              </div>
            </div>
