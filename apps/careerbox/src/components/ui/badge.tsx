  ...
  "inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        tier: {
          free: "border-transparent bg-gray-500 text-white shadow",
          entry: "border-transparent bg-blue-500 text-white shadow",
          classic: "border-transparent bg-purple-500 text-white shadow",
        }
      }
    },
    defaultVariants: {
