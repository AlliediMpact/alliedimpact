// Service Worker for Allied iMpact Coin Box PWA
const CACHE_NAME = 'coinbox-v2.0.0';
const STATIC_CACHE = 'coinbox-static-v2';
const DYNAMIC_CACHE = 'coinbox-dynamic-v2';
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: event.data ? event.data.text() : 'New notification from Allied iMpact Coin Box',
  ...
  event.waitUntil(
    self.registration.showNotification('Allied iMpact Coin Box', options)
  );
});
