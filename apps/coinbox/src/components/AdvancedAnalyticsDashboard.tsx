          ...
          <ExportButton
            data={[
              ...
              },
              {
                ...
                active: metrics.users.active.toLocaleString(),
                retention: formatPercentage(metrics.users.retentionRate),
              },
              {
                metric: 'Transaction Volume',
                value: formatCurrency(metrics.transactions.volume),
                count: metrics.transactions.total.toLocaleString(),
                successRate: formatPercentage(metrics.transactions.successRate),
              },
              {
                metric: 'Loan Performance',
                totalIssued: metrics.loans.totalIssued.toLocaleString(),
                repaymentRate: formatPercentage(metrics.loans.repaymentRate),
                defaultRate: formatPercentage(metrics.loans.defaultRate),
              },
            ]}
