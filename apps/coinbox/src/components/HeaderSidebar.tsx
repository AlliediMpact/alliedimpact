...
import { slideInLeft, slideInRight, fadeIn, staggerContainer, scaleIn } from '@/lib/animations';
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
const HeaderSidebar: React.FC<{ children: React.ReactNode }> = ({ children }) => {
        ...
        const checkUserAccess = async () => {
            if (user) {
                ...
                try {
                    ...
                    // Suppress permission errors for users who haven't completed signup
                    if (error?.code === 'permission-denied') {
                        console.debug("User access check (expected during signup):", error?.message);
                    } else {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        if (searchTerm.trim()) {
            ...
            router.push(`/${locale}/dashboard/search?q=${encodeURIComponent(searchTerm)}`);
            setShowSearch(false);
            setSearchTerm('');
        }
    };
    ...
    const handleDeposit = () => {
        router.push(`/${locale}/dashboard/wallet?action=deposit`);
    };
    ...
    const navigationItems = [
        ...
        },
        {
            label: 'Swap',
            icon: TrendingUp,
            href: `/${locale}/dashboard/swap`,
            description: 'Swap cryptocurrencies'
        },
        {
            label: 'P2P Trading',
            icon: TrendingUp,
            href: `/${locale}/dashboard/p2p-trading`,
            description: 'Trade crypto instantly with 0.5% fee'
        },
        {
            label: 'P2P Marketplace',
            icon: Users,
            href: `/${locale}/p2p-crypto/marketplace`,
        ...
        },
        {
            label: 'Savings Jar',
            icon: PiggyBank,
            href: `/${locale}/dashboard/savings-jar`,
            description: 'Auto-save from profits'
        },
        {
            label: 'Transactions',
            icon: FileText,
        ...
        },
        {
            label: 'Receipts',
            icon: FileText,
            href: `/${locale}/dashboard/receipts`,
        ...
        },
        {
            ...
            icon: BadgeAlert,
            href: `/${locale}/dashboard/risk`,
            description: 'Review risk status'
        },
        {
            label: 'Referrals',
            icon: Share2,
            href: `/${locale}/dashboard/referral`,
    ...
    const adminNavigationItems = [
        ...
        },
        {
            ...
            icon: Coins,
            href: `/${locale}/dashboard/admin/crypto`,
            description: 'Monitor crypto trades and balances'
        },
        {
            label: 'Analytics',
            icon: TrendingUp,
        ...
        },
        {
            ...
            icon: Shield,
            href: `/${locale}/dashboard/admin/transaction-monitoring`,
                            ...
                            <>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        ...
                                        <DropdownMenuItem onClick={() => router.push(`/${locale}/dashboard/membership`)}>
            ...
            <div className="flex flex-1 w-full overflow-x-hidden">
                ...
                <AnimatePresence>
                    <motion.aside
                        ...
                        initial="initial"
                        animate={isMobileMenuOpen || (typeof window !== 'undefined' && window.innerWidth >= 1024) ? "animate" : "exit"}
                        exit="exit"
                        transition={{ 
                            type: "spring", 
                            stiffness: 400, 
                    ...
                    >
                    <motion.nav 
                        className="mt-16 lg:mt-0 p-4 space-y-2"
                        ...
                        {isAdmin && (
                            <>
                                ...
                                >
                                    ...
                                    <motion.div 
                                        className="mt-1 h-px bg-gray-400/20"
                                        initial={{ scaleX: 0 }}
                                        animate={{ scaleX: 1 }}
