        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href={`/${locale}/careers`} className="hover:underline">Careers</Link>
              </li>
              <li>
                <Link href={`/${locale}/press`} className="hover:underline">Press</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={`/${locale}/education/p2p-trading`} className="flex items-center hover:underline">
                  <BookOpen className="w-4 h-4 mr-1" />
                  P2P Trading Education
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/help-center`} className="flex items-center hover:underline">
                  <HelpCircle className="w-4 h-4 mr-1" />
                  Help Center
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/system-status`} className="flex items-center hover:underline">
                  <Activity className="w-4 h-4 mr-1" />
                  System Status
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/security`} className="flex items-center hover:underline">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href={`/${locale}/compliance`} className="hover:underline">Compliance</Link>
              </li>
              <li>
                <Link href={`/${locale}/cookies`} className="hover:underline">Cookie Policy</Link>
              </li>
            </ul>
          </div>
