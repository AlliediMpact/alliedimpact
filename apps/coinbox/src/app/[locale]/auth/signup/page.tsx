...
import { Loader2, CheckCircle2, XCircle, Eye, EyeOff, Lock, ArrowRight, ShieldCheck, Mail, User, Phone } from 'lucide-react';
              ...
              <>
                {showVerifyNotice ? (
                  ...
                  <form onSubmit={handleFormSubmit} className="grid gap-4">
                    ...
                    {currentStep === 1 && (
                      <div className="mt-2 space-y-3 rounded-lg border border-slate-200 bg-slate-50/60 p-4">
                    ...
                    {currentStep === 2 && (
                      <div className="mt-1 space-y-3 rounded-lg border border-slate-200 bg-slate-50/60 p-4">
                        <div className="flex items-center justify-between">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="Basic">Basic - R550 • starter limit & core protections</SelectItem>
                            <SelectItem value="Ambassador">Ambassador - R1,100 • higher limits + referral boost</SelectItem>
                            <SelectItem value="VIP">VIP - R5,500 • premium support & fastest settlements</SelectItem>
                            <SelectItem value="Business">Business - R11,000 • team accounts & invoicing</SelectItem>
                          </SelectContent>
                        </Select>
                        <div className="bg-blue-50 border border-blue-200 rounded-md p-3 text-xs">
                          <p className="text-blue-900 font-medium mb-1">💡 Security Deposit</p>
                          <p className="text-blue-700">The amount shown is a refundable security deposit that protects both you and other traders.</p>
                        </div>
                      </div>
                    )}
                        ...
                        <div className="mt-1 rounded-lg bg-slate-900 text-slate-50 p-3 space-y-2">
                          ...
                          <div className="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs sm:text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-slate-50">{membershipTier} - {membershipTier === 'Basic' ? 'R550' : membershipTier === 'Ambassador' ? 'R1,100' : membershipTier === 'VIP' ? 'R5,500' : 'R11,000'}</p>
                            </div>
                          </div>
                        </div>
                      </>
