...
import { PageLoader, DashboardStatsGrid, StatCard, AnimatedLineChart, ActivityFeed, FAB } from '@/components/ui';
  ...
  return (
    <div className="admin-dashboard max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Monitor and manage platform operations</p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>System transactions and operations</CardDescription>
              </CardHeader>
              <CardContent>
                <AnimatedLineChart 
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.id} className="flex items-center justify-between p-3 border rounded-lg dark:border-gray-700">
                      <div>
                        <p className="font-medium text-sm dark:text-white">{item.user}</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 border rounded-lg dark:border-gray-700">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium dark:text-white">Scheduler Status</p>
