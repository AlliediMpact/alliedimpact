...
// Pricing from README: Basic R550, Ambassador R1,100, VIP R5,500, Business R11,000
const MEMBERSHIP_TIERS_CONFIG = {
  Basic: { securityFee: 550 },
  Ambassador: { securityFee: 1100 },
  VIP: { securityFee: 5500 },
  Business: { securityFee: 11000 },
};
