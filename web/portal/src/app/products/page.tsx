...
import { Wallet, FolderKanban, Car, Briefcase, BookOpen, Zap, Search, Filter, ArrowRight, Check, X } from 'lucide-react';
...
const products: Product[] = [
  {
    ...
    longDescription: 'Match talent with opportunities. AI-driven career mobility connecting job seekers with perfect roles.',
    url: '/products/careerbox',
    status: 'active',
  ...
  },
  {
    ...
    longDescription: 'Master coding and technology skills. From beginner to pro, learn the skills that matter in tech.',
    url: '/products/edutech',
    status: 'active',
    category: 'education',
  ...
  },
  {
    ...
    longDescription: 'Connect athletes, teams, and fans. Manage tournaments, share highlights, and build communities.',
    url: '/products/sportshup',
    status: 'active',
    category: 'lifestyle',
